...
String a=JOptionPane.showInputDialog("Choose an adjective");
		
		
		// Get the player to enter a type of liquid
String b=JOptionPane.showInputDialog("Choose a liquid");
		// Get the player to enter a body part
String c=JOptionPane.showInputDialog("Choose a body part");
		// Get the player to enter a verb
String d=JOptionPane.showInputDialog("Choose a verb");
		// Get the player to enter a place
String e=JOptionPane.showInputDialog("Choose a place to enter");
